...
public class InventoryResource {
    ...
    public static String edition =   System.getenv("edition");
    ...
    public void init(@Observes @Initialized(ApplicationScoped.class) Object init) throws Exception {
        System.out.println("EBR version:" + edition);
        ...
        ConnectionInitializationCallback connectionInitializationCallback = new ConnectionInitializationCallback() {
            @Override
            public void initialize(Connection connection) throws SQLException {
                connection.createStatement().execute("ALTER SESSION SET EDITION = "+edition);
                System.out.println("Change EBR to "+edition);
            }
        };
        atpInventoryPDB.registerConnectionInitializationCallback(connectionInitializationCallback);
    ...
    public Response  getInventoryCount(@QueryParam("itemid") String itemid) {
        ...
        try (Connection conn = atpInventoryPDB.getConnection()) {
            response = getInventoryCount(itemid, conn);
            System.out.println("Get Inventory result is "+ response);
        } catch (SQLException ex) {
            response = ex.getMessage();
        }
        return Response.ok()
